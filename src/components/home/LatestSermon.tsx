...
export const LatestSermon = () => {
  ...
  const latestSermon: Sermon = {
    ...
    date: '2025-06-16',
    duration: '45:22',
    thumbnail: 'https://images.unsplash.com/photo-1638173385020-6aeb3adaa983?q=80&w=2148&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    views: 1245,
    series: 'Faith in Action',
    description: 'In this powerful message, we explore how to maintain strong faith and trust in God when facing life&apos;s most challenging moments. Learn practical biblical principles for overcoming adversity.'
  };
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-blue-50 p-6 rounded-xl border border-blue-100">
            <h4 className="font-semibold text-lg mb-2 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5 mr-2 text-blue-600">
            ...
            <p className="text-sm text-muted-foreground mb-4">Download notes and discussion questions to go deeper with this week&apos;s message.</p>
          ...
          <div className="bg-yellow-50 p-6 rounded-xl border border-yellow-100">
            <h4 className="font-semibold text-lg mb-2 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5 mr-2 text-yellow-600">
                <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path>
              </svg>
              Discussion Group
            </h4>
            <p className="text-sm text-muted-foreground mb-4">Join others to discuss this message and share insights from God&apos;s Word.</p>
          ...
          <div className="bg-green-50 p-6 rounded-xl border border-green-100">
            <h4 className="font-semibold text-lg mb-2 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5 mr-2 text-green-600">
                <path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"></path>
                <circle cx="12" cy="7" r="4"></circle>
              </svg>
              Connect With Us
            </h4>
            <p className="text-sm text-muted-foreground mb-4">Have questions or need prayer? We&apos;d love to connect with you.</p>
