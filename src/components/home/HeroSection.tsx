    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gray-900 text-white">
      ...
      <div className="absolute inset-0 z-0">
        <div 
          ...
          style={{
            backgroundImage: "url('https://images.unsplash.com/photo-1543525238-54e3d131f7ca?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
      ...
      <div className="container relative z-10 mx-auto px-4 text-center">
        <div className="max-w-6xl mx-auto py-20 mt-8">
          ...
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold mb-8 leading-tight tracking-tight">
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-yellow-300 via-yellow-400 to-yellow-300">Experience God's</span>{' '}
            <span className="text-white">Love</span>
            <br className="hidden lg:block" />
            <span className="text-white">and</span>{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-yellow-300 to-yellow-400">Transforming Power</span>
          </h1>
          
          <p className="text-xl md:text-2xl lg:text-3xl text-blue-100 max-w-4xl mx-auto mb-8 leading-relaxed font-light">
            Join our vibrant community as we worship, grow, and serve together in Christ's love. 
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center mb-10">
            ...
            >
              <span className="relative z-10 flex items-center">
                Learn About Us
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="ml-3 h-5 w-5 transition-transform duration-300 group-hover:translate-x-1">
                  <path d="M5 12h14"/>
          ...
          <div className="inline-block bg-gradient-to-br from-white/5 to-white/[0.03] backdrop-blur-sm border border-white/10 rounded-2xl p-7 shadow-2xl transform transition-all duration-500 hover:scale-[1.02] hover:shadow-yellow-400/10">
            ...
            <div className="flex flex-wrap justify-center gap-x-8 gap-y-4">
              ...
              >
                View All Services
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="ml-1.5 h-4 w-4 transition-transform duration-300 group-hover:translate-x-1">
                  <path d="M5 12h14"/>
                  <path d="m12 5 7 7-7 7"/>
                </svg>
              </Button>
