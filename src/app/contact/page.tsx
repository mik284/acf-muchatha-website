        ...
        <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-4xl mx-auto">
          <div className="flex items-center gap-3 p-4 bg-background/50 rounded-lg border">
            ...
            <div>
              ...
              <a
                href="mailto:info@ambassadorsforchrist.org"
                className="font-medium hover:underline"
              >
                info@ambassadorsforchrist.org
              </a>
            </div>
          </div>
          <div className="flex items-center gap-3 p-4 bg-background/50 rounded-lg border">
            ...
            <div className="bg-muted/30 p-6 rounded-xl">
              ...
              <div className="flex gap-4">
                <Button variant="outline" size="icon" asChild>
                  <a
                    href="https://facebook.com/ambassadorsforchrist"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Facebook"
                  >
                ...
                <Button variant="outline" size="icon" asChild>
                  <a
                    href="https://twitter.com/ambassadorsfc"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Twitter"
                  >
                ...
                <Button variant="outline" size="icon" asChild>
                  <a
                    href="https://instagram.com/ambassadorsforchrist"
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <Button variant="outline" size="icon" asChild>
                  <a
                    href="https://youtube.com/ambassadorsforchrist"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="YouTube"
                  >
