...
import { Calendar, Users, Heart, BookOpen, MapPin, Clock, Mail, Phone, ArrowRight } from 'lucide-react';
    ...
    <main className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="md:w-1/2">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="mb-4">
                Founded in 1995, Ambassadors For Christ began as a small Bible study group in a living room. 
                What started with just a handful of faithful believers has grown into a thriving community 
                impacting thousands of lives in our city and beyond.
              </p>
              <p className="mb-4">
                Our journey has been marked by God's faithfulness as we've seen countless lives transformed 
                through the power of the Gospel. We believe in creating a welcoming environment where people 
                from all walks of life can encounter Jesus and grow in their faith.
              </p>
              <p>
                Today, we continue to be a beacon of hope in our community, committed to making disciples 
                who make disciples, and being the hands and feet of Jesus to those in need.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="mb-20">
        <div className="grid md:grid-cols-2 gap-8">
          <Card className="border-primary/20">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                ...
                where people are equipped to know God, find freedom, discover purpose, and make a difference.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-primary/20">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                To be a church where the Gospel is preached, lives are transformed, and communities are 
                impacted for Christ. We envision a multi-ethnic, multi-generational church that reflects 
          ...
          {[
            {
              ...
              description: 'We are committed to the authority and sufficiency of Scripture in all matters of faith and practice.'
            },
            {
              title: 'Authentic Worship',
              description: 'We pursue genuine encounters with God through Spirit-led worship and prayer.'
            },
            {
              title: 'Intentional Discipleship',
              description: 'We are committed to growing together in Christ-likeness through intentional relationships.'
            },
            {
      ...
      <section className="bg-primary/5 rounded-2xl p-8 md:p-12 text-center mb-20">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto mb-8">
          We'd love to welcome you this Sunday! Let us know you're coming and we'll make sure 
